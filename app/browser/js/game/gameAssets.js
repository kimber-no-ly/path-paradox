pathParadox.factory('gameAssets', function() {
  return {
    ...
    starttop: createStartPointsTop(),
    startleft: createStartPointsLeft(),
    startbottom: createStartPointsBottom(),
    startright: createStartPointsRight()
    };
});

function createStartPointsTop () {
	let array = [];
	for(let i = 0; i < 6; i++){ array.push([i,0,0],[i,0,1]); }
	return array;
}

function createStartPointsLeft () {
	let array = [];
	for(let i = 0; i < 6; i++){ array.push([0,i,7],[0,i,6]); }
	return array;
}

function createStartPointsBottom () {
	let array = [];
	for(let i = 0; i < 6; i++){ array.push([i,5,5],[i,5,4]); }
	return array;
}

function createStartPointsRight () {
	let array = [];
	for(let i = 0; i < 6; i++){ array.push([5,i,2],[5,i,3]); }
	return array;
}
